...
{
    public partial class RegistrantionAdmin : Form
    {
        private string fname, lname, email, password, nid, phone, address, role, dob, luserId;
        private int userId;

        private void RegistrantionAdmin_Load(object sender, EventArgs e)
        {
        ...
        public RegistrantionAdmin(string username)
        {
            InitializeComponent();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (cbRole.SelectedIndex == 0 || cbRole.SelectedItem == null)
            {
            ...
            if (txtFname != null && txtLname != null && txtEmail != null && txtPassword != null && txtNid != null && txtPhoneNumber != null && richTextBox1 != null && dateTimePicker1.Value.Date < DateTime.Now.Date && cbRole.SelectedIndex != 0)
            {
